...
This model extends the :doc:`ODE-SECIRVVS model <osecirvvs>` by adding waning immunity and introducing temporary immunity states that change the meaning of recovery.
