...
.. code-block:: cpp
    ...
    mio::TimeSeries<ScalarType> result_sim = mio::oseirdb::simulate(t0, tmax, dt, model);
...
.. code-block:: cpp
    ...
    mio::TimeSeries<ScalarType> result_sim = mio::oseirdb::simulate(t0, tmax, dt, model, std::move(integrator));
