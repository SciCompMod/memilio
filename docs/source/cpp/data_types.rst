...
.. list-table::
   ...
   * - :code:`Distance`
     - Represents a distance. Internally, all distances are stored in meters. They can be created from meters or kilometers and they can be exported using both units. See :MEmilio:`doxysphinx:kilometers`
