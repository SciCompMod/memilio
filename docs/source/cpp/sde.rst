...
The class used for implementing SDE models is called :code:`StochasticModel`. It is derived from a ``CompartmentalModel``
...
Flow information cannot be obtained even when the :code:`StochasticModel` is defined using a :code:`FlowModel`, as the
