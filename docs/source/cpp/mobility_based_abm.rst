...
1. **Infection States**: Similar to the aggregated models (see, e.g., :doc:`equation based models<ode>`), an infected person progresses through states defined in `infection_state.h <https://github.com/SciCompMod/memilio/blob/main/cpp/models/abm/symptom_state.h>`_:
