...
A key distinction between the model types lies in their assumptions about the dwelling time distribution of individuals within a compartment. ODE-based models implicitly assume exponentially distributed dwelling times, leading to a memoryless transitions between compartments. The Linear Chain Trick (LCT) and its generalization (GLCT) allow Erlang or Gamma distributions, providing more realistic, non-exponential dwelling times. IDE-based models offer the greatest flexibility, supporting arbitrary transition distributions. SDE models extend ODE models by introducing stochastic fluctuations.
