...
parameter_data = [
    {"name": "TimeExposed",
     ...
     {"name": "StartDayNewVariant",
     "description": "StartDayNewVariant"}
]
...
parameters  = [parameter["id"] for parameter in get_parameters.json()]
...
nodelist_data = {
  "name": "all_counties",
  "description": "Coontains all counties of Germany as well as a node for the whole of Germany.",
  "nodeIds": nodes
}
