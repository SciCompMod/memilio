...
int main()
{
    ...
    model.populations[{mio::AgeGroup(0), mio::oseirvector::InfectionState::Exposed}]   = 100;
    model.populations[{mio::AgeGroup(0), mio::oseirvector::InfectionState::Infected}]  = 100;
    model.populations[{mio::AgeGroup(0), mio::oseirvector::InfectionState::Recovered}] = 100;
