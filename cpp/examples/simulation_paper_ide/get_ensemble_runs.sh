#!/bin/bash
#SBATCH --job-name=ide-ensemble
#SBATCH --output=ide-ensemble%A.out
#SBATCH --error=ide-ensemble%A.err
#SBATCH --nodes=3
#SBATCH --ntasks=168
...
do
    ...
    mpirun -n $num_mpi ./bin/ide_ensemble_runs -NumberEnsembleRuns $num_runs
done
