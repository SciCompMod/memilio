...
simulate_with_init(
    std::string farm_file, ScalarType tmax = 80, ScalarType dt = 1.0, ScalarType suspicion_threshold = 15,
    ...
    ScalarType foi_outer_factor4 = 0.5, ScalarType damping0 = 1.0, ScalarType damping1 = 1.0, ScalarType damping2 = 1.0,
    ScalarType damping3 = 1.0, ScalarType damping4 = 1.0, ScalarType first_infection_day = 0,
    ScalarType second_infection_day = 2, ScalarType third_infection_day = 2, u_int seed = 434)
{
    const auto t0 = 0.;
...
simulate(
    ...
    const ScalarType t, ScalarType tmax = 80, ScalarType dt = 1.0, ScalarType suspicion_threshold = 15,
    ScalarType sensitivity = 0.95, ScalarType h0 = 0.001, ScalarType r0 = 1000, ScalarType alpha = 2,
    ScalarType infection_baseline = 0.0001, ScalarType culling_factor = 0.99, ScalarType A0_SEI = 0.002,
    ScalarType A0_EI = 0.1, ScalarType A0_ID = 0.1, ScalarType A0_DeathRate = 0.000128, ScalarType A1_SEI = 0.002,
    ScalarType A1_EI = 0.1, ScalarType A1_ID = 0.1, ScalarType A1_DeathRate = 0.000128, ScalarType A2_SEI = 0.002,
...
int main()
{
    ...
    auto sim    = simulate_with_init(farm_file, 60);
    ...
    double tmax = 20;
    auto sim1   = simulate_with_init(farm_file, tmax);
    result      = sim1.get_confirmation_dates(tmax);
    mio::log_info("Number of infected farms: {}", std::count_if(result.begin(), result.end(), [](int r) {
                      return r >= 0;
                  }));
    auto sim_continue = simulate(sim1, tmax, tmax + 40);
