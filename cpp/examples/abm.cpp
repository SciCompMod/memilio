 ...
 */
mio::HouseholdGroup make_homes_with_families(const mio::HouseholdMember& child, const mio::HouseholdMember& parent, const mio::HouseholdMember& random, int number_of_persons_in_household, int number_of_full_familes, int number_of_half_familes, int number_of_other_familes){
...
void assign_infection_state(mio::World& world, double exposed_pct, double infected_pct,
...
int main()
{
    ...
    abm_params.set<mio::SusceptibleToExposedByInfected>({{mio::AbmAgeGroup::Count,mio::VaccinationState::Count}, 0.02});
