...
TutorialCpp_NLP::TutorialCpp_NLP(bool use_hessian_approximation) noexcept
{
    ...
    g_l_.resize(m_);
    g_u_.resize(m_);
    g_l_[0] = 25.0; g_u_[0] = INF;
    g_l_[1] = 40.0; g_u_[1] = 40.0;
}
...
bool TutorialCpp_NLP::eval_h(
    ...
    if (values == nullptr) {
        ...
        iRow[idx] = 0; jCol[idx++] = 0;
        iRow[idx] = 0; jCol[idx++] = 1;
        iRow[idx] = 0; jCol[idx++] = 2;
        iRow[idx] = 0; jCol[idx++] = 3;
        // Row 1: (1,1),(1,2),(1,3)
        iRow[idx] = 1; jCol[idx++] = 1;
        iRow[idx] = 1; jCol[idx++] = 2;
        iRow[idx] = 1; jCol[idx++] = 3;
        // Row 2: (2,2),(2,3)
        iRow[idx] = 2; jCol[idx++] = 2;
        iRow[idx] = 2; jCol[idx++] = 3;
        // Row 3: (3,3)
        iRow[idx] = 3; jCol[idx++] = 3;
    } else {
