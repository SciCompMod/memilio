 ...
 */
void set_covid_parameters(mio::oseirmobilityimproved::Parameters<double>& params)
{
...
void set_mobility_weights(mio::oseirmobilityimproved::Model<FP>& model)
{
...
template <typename FP = ScalarType>
void set_parameters_and_population(mio::oseirmobilityimproved::Model<FP>& model)
{
