...
// Forward declaration of the main function in abm_minimal.cu
extern int abm_minimal_main(int size);
...
/**
 * @brief Main function that calls abm_minimal_main
 * @param argc Number of command-line arguments
 * @param argv Array of command-line arguments
 * @return Exit code
 */
int main() {
    // Simply call the main function from abm_minimal.cu
    runABMSimulation();
    abm_minimal_main(5);
