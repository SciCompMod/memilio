...
simulate(std::string farm_file, ScalarType tmax = 80, ScalarType dt = 1.0, ScalarType suspicion_threshold = 15,
         ScalarType sensitivity = 0.95, ScalarType infection_baseline = 0.0001, ScalarType culling_factor = 0.99,
         ScalarType cutoff1 = 1000, ScalarType cutoff2 = 5000, ScalarType cutoff3 = 10000, ScalarType value2 = 0.5,
         ScalarType value3 = 0.2, ScalarType A0_SEI = 0.002, ScalarType A0_EI = 0.1, ScalarType A0_ID = 0.1,
         ScalarType A0_DeathRate = 0.000128, ScalarType A1_SEI = 0.002, ScalarType A1_EI = 0.1, ScalarType A1_ID = 0.1,
         ScalarType A1_DeathRate = 0.000128, ScalarType A2_SEI = 0.002, ScalarType A2_EI = 0.1, ScalarType A2_ID = 0.1,
         ScalarType A2_DeathRate = 0.000588, ScalarType A3_SEI = 0.002, ScalarType A3_EI = 0.1, ScalarType A3_ID = 0.1,
         ScalarType A3_DeathRate = 0.000588, ScalarType A4_SEI = 0.002, ScalarType A4_EI = 0.1, ScalarType A4_ID = 0.1,
         ScalarType A4_DeathRate = 0.000588, ScalarType foi_inner_factor0 = 0.5, ScalarType foi_outer_factor0 = 0.5,
         ScalarType foi_inner_factor1 = 0.5, ScalarType foi_outer_factor1 = 0.5, ScalarType foi_inner_factor2 = 0.5,
         ScalarType foi_outer_factor2 = 0.5, ScalarType foi_inner_factor3 = 0.5, ScalarType foi_outer_factor3 = 0.5,
