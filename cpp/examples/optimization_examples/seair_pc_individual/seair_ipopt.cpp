    ...
    : settings_(settings)
{
    ...
    m_ = settings_.numIntervals * settings_.numPathConstraints + settings_.numTerminalConstraints;
    ...
    int terminalOffset = settings_.numIntervals * settings_.numPathConstraints;
