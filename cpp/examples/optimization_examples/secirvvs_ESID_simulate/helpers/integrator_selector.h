...
std::shared_ptr<mio::IntegratorCore<FP>> make_integrator(IntegratorType type, FP dt)
{
    ...
    case IntegratorType::ExplicitCashKarp54: {
        auto cashKarpStepper          = std::make_shared<mio::ExplicitStepperWrapper<FP, runge_kutta_cash_karp54>>();
    ...
    case IntegratorType::ExplicitFehlberg78: {
        auto fehlbergStepper          = std::make_shared<mio::ExplicitStepperWrapper<FP, runge_kutta_fehlberg78>>();
    ...
    case IntegratorType::ControlledCashKarp54: {
        auto cashKarpControlled = std::make_shared<mio::ControlledStepperWrapper<FP, runge_kutta_cash_karp54>>();
    ...
    case IntegratorType::ControlledFehlberg78: {
        auto fehlbergControlled = std::make_shared<mio::ControlledStepperWrapper<FP, runge_kutta_fehlberg78>>();
