...
initialize_simulation(FP t0, FP tmax)
{
    // --------------------------- //
    ...
    size_t tmax_days = static_cast<size_t>(tmax);
    ...
    for (size_t age_group = 0; age_group < num_age_groups; age_group++) {
        for (size_t current_day = 0; current_day <= tmax_days; current_day++) {
            mio::Index<mio::AgeGroup, mio::SimulationDay> index{mio::AgeGroup(age_group), mio::SimulationDay(current_day)};
    ...
    population << 
        2753030.497430, 0.000000, 11.708820, 0.000000, 2.212815, 7.578866, 0.000000, 4.084619, 0.000000, 0.000000, 0.000000, 22.853384, 0.000000, 2.146616, 0.000000, 0.000000, 0.000000, 0.150378, 0.000000, 0.001865, 0.150441, 0.000000, 0.005732, 1051258.609035, 64.000000, 0.000000, 0.000000,
        3326384.779416, 0.000000, 5.015423, 0.000000, 3.287046, 2.945401, 0.000000, 5.907620, 0.000000, 0.000000, 0.000000, 5.168372, 0.000000, 1.831628, 0.000000, 0.000000, 0.000000, 0.023957, 0.000000, 0.001460, 0.138450, 0.000000, 0.017723, 4506996.883505, 45.000000, 0.000000, 0.000000,
        7474316.734280, 0.000000, 15.185091, 0.000000, 9.963930, 10.119921, 0.000000, 19.347768, 0.000000, 0.000000, 0.000000, 27.662806, 0.000000, 9.908623, 0.000000, 0.000000, 0.000000, 0.839570, 0.000000, 0.044404, 0.349355, 0.000000, 0.046282, 11247005.297970, 510.000000, 0.000000, 0.000000,
        13079641.709818, 0.000000, 28.087697, 0.000000, 14.523549, 23.028794, 0.000000, 36.771572, 0.000000, 0.000000, 0.000000, 74.950401, 0.000000, 21.335313, 0.000000, 0.000000, 0.000000, 7.139552, 0.000000, 0.287452, 2.329300, 0.000000, 0.231930, 15095393.104624, 8936.000000, 0.000000, 0.000000,
        12370660.206757, 0.000000, 66.165784, 0.000000, 13.006396, 51.098574, 0.000000, 30.752489, 0.000000, 0.000000, 0.000000, 162.557513, 0.000000, 16.728201, 0.000000, 0.000000, 0.000000, 38.893189, 0.000000, 0.564814, 13.248394, 0.000000, 0.494789, 5239420.683100, 56248.571429, 0.000000, 0.000000,
        5614932.848062, 0.000000, 61.140294, 0.000000, 9.149288, 46.298860, 0.000000, 21.109925, 0.000000, 0.000000, 0.000000, 137.630764, 0.000000, 11.369236, 0.000000, 0.000000, 0.000000, 59.433799, 0.000000, 0.673454, 24.245028, 0.000000, 0.742577, 1695860.958713, 121825.428571, 0.000000, 0.000000;

    for (size_t column = 0; column < population.cols(); column++) {
        for (size_t row = 0; row < population.rows(); row++){
            mio::Index<mio::AgeGroup, mio::osecirvvs::InfectionState> index{
                mio::AgeGroup(row), mio::osecirvvs::InfectionState(column)
            };
    ...
    mio::Graph<mio::SimulationNode<FP, mio::Simulation<FP, mio::osecirvvs::Model<FP>>>, mio::MobilityEdge<FP>> graph_simulation;

    graph_simulation.add_node(1001, model);
    graph_simulation.add_node(1002, model);

    mio::MobilityEdge<FP> edge0(mio::MobilityParameters<FP>(Eigen::VectorX<FP>::Zero(num_age_groups * num_infection_states)));
    mio::MobilityEdge<FP> edge1(mio::MobilityParameters<FP>(Eigen::VectorX<FP>::Zero(num_age_groups * num_infection_states)));
    graph_simulation.add_edge(1001, 1002, edge0);
    graph_simulation.add_edge(1002, 1001, edge1);
