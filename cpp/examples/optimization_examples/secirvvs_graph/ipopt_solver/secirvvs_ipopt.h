...
private:
    ...
    mio::Graph<mio::SimulationNode<double, mio::Simulation<double, mio::osecirvvs::Model<double>>>,
        ...
        m_graph_model_double;
    // forward-mode (tangent-linear) AD model for Jacobian via GT1S
    mio::Graph<
        mio::SimulationNode<ad::gt1s<double>::type,
                            mio::Simulation<ad::gt1s<double>::type, mio::osecirvvs::Model<ad::gt1s<double>::type>>>,
        mio::MobilityEdge<ad::gt1s<double>::type>>
        m_graph_model_tangent_linear;
    // reverse-mode (adjoint) AD model for gradient via GA1S
    mio::Graph<
        mio::SimulationNode<ad::ga1s<double>::type,
                            mio::Simulation<ad::ga1s<double>::type, mio::osecirvvs::Model<ad::ga1s<double>::type>>>,
        mio::MobilityEdge<ad::ga1s<double>::type>>
        m_graph_model_adjoint;
