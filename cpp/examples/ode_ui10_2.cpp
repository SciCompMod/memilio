...
int main()
{
    ...
    for (auto i = mio::AgeGroup(0); i < mio::AgeGroup(num_groups); i++) {
        ...
        model.parameters.get<mio::oui10::TimeInfectedV1<double>>()[i]                     = 7 * std::pow(base, 3);
        model.parameters.get<mio::oui10::TimeInfectedV2<double>>()[i]                     = 7 * std::pow(base, 4);
        model.parameters.get<mio::oui10::TimeInfectedV3<double>>()[i]                     = 7 * std::pow(base, 5);
        model.parameters.get<mio::oui10::TimeInfectedV1<double>>()[i]                     = 7 * std::pow(base, 6);
        model.parameters.get<mio::oui10::TimeInfectedV2<double>>()[i]                     = 7 * std::pow(base, 7);
        model.parameters.get<mio::oui10::TimeInfectedV3<double>>()[i]                     = 7 * std::pow(base, 8);
        model.parameters.get<mio::oui10::TimeInfectedV1<double>>()[i]                     = 7 * std::pow(base, 9);
