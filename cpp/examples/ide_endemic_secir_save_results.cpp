...
mio::IOResult<void> simulate_endidemodel(ScalarType tmax, std::string save_dir = "")
{
    ...
    if (!save_dir.empty()) {
        ...
        std::string filename_ide_normcompartments = filename_ide + "_normcompartments1.h5";
        ...
        std::string filename_ide_forceofinfection = filename_ide + "_forceofinfection1.h5";
