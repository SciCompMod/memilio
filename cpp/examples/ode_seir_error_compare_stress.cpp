...
int main()
{
    ...
    model.parameters.set<mio::oseir::TimeExposed<ScalarType>>(1.2);
    model.parameters.set<mio::oseir::TimeInfected<ScalarType>>(1.6);
    model.parameters.set<mio::oseir::TransmissionProbabilityOnContact<ScalarType>>(0.8);
