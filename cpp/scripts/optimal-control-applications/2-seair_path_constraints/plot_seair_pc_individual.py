...
# Load the CSV file
data = pd.read_csv('result_seair_pc_individual.csv')
...
plt.tight_layout()
plt.savefig('result_seair_pc_individual.png')  # Save the figure
plt.show()

# Load data from the CSV file
df = pd.read_csv('controls_seair_pc_individual.csv')
...
plt.tight_layout()
# Save the figure
plt.savefig('controls_seair_pc_individual.png')
plt.show()
