...
TEST(TestSMMSimulation, advance)
{
    ...
    for (size_t region = 0; region < 2; ++region) {
        adoption_rates.push_back({InfectionState::S,
                                  InfectionState::E,
                                  mio::smm::Region(region),
                                  0.1,
                                  {InfectionState::C, InfectionState::I},
                                  {1, 0.5}});
        adoption_rates.push_back({InfectionState::E, InfectionState::C, mio::smm::Region(region), 1.0 / 5., {}, {}});
        adoption_rates.push_back({InfectionState::C, InfectionState::R, mio::smm::Region(region), 0.2 / 3., {}, {}});
        adoption_rates.push_back({InfectionState::C, InfectionState::I, mio::smm::Region(region), 0.8 / 3., {}, {}});
        adoption_rates.push_back({InfectionState::I, InfectionState::R, mio::smm::Region(region), 0.99 / 5., {}, {}});
        adoption_rates.push_back({InfectionState::I, InfectionState::D, mio::smm::Region(region), 0.01 / 5., {}, {}});
    }

    for (size_t s = 0; s < static_cast<size_t>(InfectionState::D); ++s) {
        transition_rates.push_back({InfectionState(s), mio::smm::Region(0), mio::smm::Region(1), 0.01});
        transition_rates.push_back({InfectionState(s), mio::smm::Region(1), mio::smm::Region(0), 0.01});
    }
