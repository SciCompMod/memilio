...
TEST(TestMigrationRules, student_goes_to_school)
{
    ...
    auto p_child =
        mio::abm::Person(home, mio::abm::InfectionState::Susceptible, AGE_5_TO_14, mio::abm::SimulationParameters(6));
    auto p_adult =
...
TEST(TestMigrationRules, school_return)
{
    ...
    auto p_child =
        mio::abm::Person(school, mio::abm::InfectionState::Susceptible, AGE_5_TO_14, mio::abm::SimulationParameters(6));
...
TEST(TestMigrationRules, worker_goes_to_work)
{
    ...
    auto p_retiree =
        mio::abm::Person(home, mio::abm::InfectionState::Susceptible, AGE_60_TO_79, mio::abm::SimulationParameters(6));
    auto p_adult =
        mio::abm::Person(home, mio::abm::InfectionState::Susceptible, AGE_15_TO_34, mio::abm::SimulationParameters(6));
...
TEST(TestMigrationRules, work_return)
{
    ...
    auto p_adult =
        mio::abm::Person(work, mio::abm::InfectionState::Susceptible, AGE_35_TO_59, mio::abm::SimulationParameters(6));
...
TEST(TestMigrationRules, quarantine)
{
    ...
    auto p_inf1 = mio::abm::Person(work, {mio::abm::InfectionState::Infected, true}, AGE_15_TO_34,
    ...
    auto p_inf2 = mio::abm::Person(work, {mio::abm::InfectionState::Infected, false}, AGE_15_TO_34,
                                   mio::abm::SimulationParameters(6));
    ...
    auto p_inf3 = mio::abm::Person(hospital, {mio::abm::InfectionState::Infected_Severe, true}, AGE_15_TO_34,
                                   mio::abm::SimulationParameters(6));
...
{
    auto home  = mio::abm::Location(mio::abm::LocationType::Home, 0, 6);
    auto p_inf = mio::abm::Person(home, mio::abm::InfectionState::Infected_Severe, AGE_15_TO_34,
                                  mio::abm::SimulationParameters(6));
    auto t     = mio::abm::TimePoint(12346);
    auto dt    = mio::abm::hours(1);
    ...
    auto p_car =
        mio::abm::Person(home, mio::abm::InfectionState::Infected, AGE_15_TO_34, mio::abm::SimulationParameters(6));
...
TEST(TestMigrationRules, go_shopping)
{
    auto hospital = mio::abm::Location(mio::abm::LocationType::Hospital, 0, 6);
    auto p_hosp =
        mio::abm::Person(hospital, mio::abm::InfectionState::Infected, AGE_0_TO_4, mio::abm::SimulationParameters(6));
    auto home = mio::abm::Location(mio::abm::LocationType::Home, 0, 6);
    auto p_home =
        mio::abm::Person(home, mio::abm::InfectionState::Susceptible, AGE_60_TO_79, mio::abm::SimulationParameters(6));
...
{
    auto hospital = mio::abm::Location(mio::abm::LocationType::Hospital, 0, 6);
    auto p_hosp   = mio::abm::Person(hospital, mio::abm::InfectionState::Infected_Critical, AGE_15_TO_34,
                                     mio::abm::SimulationParameters(6));
    auto t        = mio::abm::TimePoint(12346);
    auto dt       = mio::abm::hours(1);
    ...
    auto work = mio::abm::Location(mio::abm::LocationType::Work, 0, 6);
    auto p_work =
        mio::abm::Person(work, mio::abm::InfectionState::Infected, AGE_15_TO_34, mio::abm::SimulationParameters(6));
...
{
    auto hospital = mio::abm::Location(mio::abm::LocationType::Hospital, 0, 6);
    auto p_rec    = mio::abm::Person(hospital, mio::abm::InfectionState::Recovered_Infected, AGE_60_TO_79,
                                     mio::abm::SimulationParameters(6));
    auto p_inf    = mio::abm::Person(hospital, mio::abm::InfectionState::Infected_Severe, AGE_60_TO_79,
                                     mio::abm::SimulationParameters(6));
    auto t        = mio::abm::TimePoint(12346);
    auto dt       = mio::abm::hours(1);
