...
TEST(TestRegions, get_holidays)
{
    ...
    auto s1 = mio::regions::de::get_holidays(mio::regions::de::StateId(1), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s1.size(), 1);
    ASSERT_EQ(s1[0], std::make_pair(mio::Date(2020, 10, 5), mio::Date(2020, 10, 18)));

    auto s2 = mio::regions::de::get_holidays(mio::regions::de::StateId(2), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s2.size(), 1);
    ASSERT_EQ(s2[0], std::make_pair(mio::Date(2020, 10, 5), mio::Date(2020, 10, 17)));

    auto s4 = mio::regions::de::get_holidays(mio::regions::de::StateId(4), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s4.size(), 1);
    ASSERT_EQ(s4[0], std::make_pair(mio::Date(2020, 10, 12), mio::Date(2020, 10, 25)));

    auto s5 = mio::regions::de::get_holidays(mio::regions::de::StateId(5), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s5.size(), 1);
    ASSERT_EQ(s5[0], std::make_pair(mio::Date(2020, 10, 12), mio::Date(2020, 10, 25)));

    auto s6 = mio::regions::de::get_holidays(mio::regions::de::StateId(6), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s6.size(), 1);
    ASSERT_EQ(s6[0], std::make_pair(mio::Date(2020, 10, 5), mio::Date(2020, 10, 18)));

    auto s7 = mio::regions::de::get_holidays(mio::regions::de::StateId(7), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s7.size(), 1);
    ASSERT_EQ(s7[0], std::make_pair(mio::Date(2020, 10, 12), mio::Date(2020, 10, 24)));

    auto s8 = mio::regions::de::get_holidays(mio::regions::de::StateId(8), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s8.size(), 1);
    ASSERT_EQ(s8[0], std::make_pair(mio::Date(2020, 10, 26), mio::Date(2020, 10, 31)));

    auto s9 = mio::regions::de::get_holidays(mio::regions::de::StateId(9), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s9.size(), 1);
    ASSERT_EQ(s9[0], std::make_pair(mio::Date(2020, 10, 31), mio::Date(2020, 11, 7)));

    auto s10 = mio::regions::de::get_holidays(mio::regions::de::StateId(10), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s10.size(), 1);
    ASSERT_EQ(s10[0], std::make_pair(mio::Date(2020, 10, 12), mio::Date(2020, 10, 24)));

    auto s11 = mio::regions::de::get_holidays(mio::regions::de::StateId(11), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s11.size(), 1);
    ASSERT_EQ(s11[0], std::make_pair(mio::Date(2020, 10, 12), mio::Date(2020, 10, 25)));

    auto s12 = mio::regions::de::get_holidays(mio::regions::de::StateId(12), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s12.size(), 1);
    ASSERT_EQ(s12[0], std::make_pair(mio::Date(2020, 10, 12), mio::Date(2020, 10, 25)));

    auto s13 = mio::regions::de::get_holidays(mio::regions::de::StateId(13), mio::Date(2020, 10, 1), mio::Date(2020, 11, 15));
    ASSERT_EQ(s13.size(), 1);
    ASSERT_EQ(s13[0], std::make_pair(mio::Date(2020, 10, 5), mio::Date(2020, 10, 11)));

    auto s14 = mio::regions::de::get_holidays(mio::regions::de::StateId(14), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s14.size(), 1);
    ASSERT_EQ(s14[0], std::make_pair(mio::Date(2020, 10, 19), mio::Date(2020, 11, 1)));

    auto s15 = mio::regions::de::get_holidays(mio::regions::de::StateId(15), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s15.size(), 1);
    ASSERT_EQ(s15[0], std::make_pair(mio::Date(2020, 10, 19), mio::Date(2020, 10, 25)));

    auto s16 = mio::regions::de::get_holidays(mio::regions::de::StateId(16), mio::Date(2020, 10, 15), mio::Date(2020, 11, 15));
    ASSERT_EQ(s16.size(), 1);
    ASSERT_EQ(s16[0], std::make_pair(mio::Date(2020, 10, 17), mio::Date(2020, 10, 31)));

    auto s3 = mio::regions::de::get_holidays(mio::regions::de::StateId(3), mio::Date(2020, 7, 30), mio::Date(2020, 12, 31));
    ASSERT_EQ(s3.size(), 3);
