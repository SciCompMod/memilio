...
TEST(TestLocation, addSubpopulationsTimepoint)
{
    ...
    ASSERT_EQ(v1[double(mio::abm::InfectionState::Infected)], 2); // Check whether the number of persons in infected state at the location is correct
    ...
    ASSERT_EQ(v2[double(mio::abm::InfectionState::Infected)], 1); // Check whether the number of persons in infected state at the location is correct
    ...
    ASSERT_EQ(v3[double(mio::abm::InfectionState::Infected)], 2); // Check whether the number of persons in infected state at the location is correct
