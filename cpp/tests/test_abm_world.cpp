...
TEST(TestWorld, getSubpopulationCombined)
{
    ...
    ASSERT_EQ(world.get_subpopulation_combined(t, mio::abm::InfectionState::InfectedNoSymptoms, mio::abm::LocationType::School),
              2);
}
...
TEST(TestWorld, evolveStateTransition)
{
    ...
    auto& p1 = add_test_person(world, location1, mio::abm::AgeGroup::Age15to34, mio::abm::InfectionState::InfectedNoSymptoms);
    ...
    auto& p3 = add_test_person(world, location2, mio::abm::AgeGroup::Age15to34, mio::abm::InfectionState::InfectedSymptoms);
...
TEST(TestWorld, evolveMigration)
{
...

    {
        ...
        auto& p1 = add_test_person(world, home_id, mio::abm::AgeGroup::Age15to34, mio::abm::InfectionState::InfectedNoSymptoms, t);
...
TEST(TestWorldTestingCriteria, testAddingAndUpdatingAndRunningTestingSchemes)
{
    ...
    auto person = add_test_person(world, home_id, mio::abm::AgeGroup::Age15to34, mio::abm::InfectionState::InfectedSymptoms,
                                  current_time);
    person.set_assigned_location(home);
    person.set_assigned_location(work);
