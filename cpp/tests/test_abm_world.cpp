...
TEST(TestWorld, copyWorld)
{
    ...
    ASSERT_EQ(&(world.get_persons()[0].get_location()), &(world.get_persons()[0].get_location()));
    ASSERT_EQ(&(world.get_persons()[1].get_location()), &(world.get_persons()[1].get_location()));
