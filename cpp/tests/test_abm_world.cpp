...
TEST(TestWorld, evolveMigration)
{
...

    {
        ...
        EXPECT_EQ(school.get_time_series_subpopulations().get_last_value().sum(), 1);
        EXPECT_EQ(work.get_time_series_subpopulations().get_last_value().sum(), 1);
    }

    {
        ...
        EXPECT_EQ(event.get_time_series_subpopulations().get_last_value().sum(), 1);
        EXPECT_EQ(work.get_time_series_subpopulations().get_last_value().sum(), 1);
        EXPECT_EQ(home.get_time_series_subpopulations().get_last_value().sum(), 2);
        EXPECT_EQ(hospital.get_time_series_subpopulations().get_last_value().sum(), 1);
    }
}
