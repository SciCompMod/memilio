...
TEST(TestSimulation, advance_subpopulation)
{
    ...
    auto person1 =
        add_test_person(world, location_id, AGE_GROUP_5_TO_14, mio::abm::InfectionState::Infected);
    auto person2 =
        add_test_person(world, location_id, AGE_GROUP_15_TO_34, mio::abm::InfectionState::Infected);
    auto person3 =
