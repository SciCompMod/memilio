...
TEST(TestLockdownRules, school_closure)
{
    ...
    auto p1 = mio::abm::Person(rng, home.get_type(), home.get_id(), home.get_model_id(), age_group_5_to_14);
    ...
    auto p2 = mio::abm::Person(rng, home.get_type(), home.get_id(), home.get_model_id(), age_group_5_to_14);
...
TEST(TestLockdownRules, school_opening)
{
    ...
    EXPECT_CALL(mock_uniform_dist.get_mock(), invoke)
        ...
        .WillOnce(testing::Return(0.6))
        .WillRepeatedly(testing::Return(1.0));
    auto p = mio::abm::Person(rng, home.get_type(), home.get_id(), home.get_model_id(), age_group_5_to_14);
...
TEST(TestLockdownRules, home_office)
{
    ...
    auto person1 = mio::abm::Person(rng, home.get_type(), home.get_id(), home.get_model_id(), age_group_15_to_34);
    auto person2 = mio::abm::Person(rng, home.get_type(), home.get_id(), home.get_model_id(), age_group_15_to_34);
...
TEST(TestLockdownRules, no_home_office)
{
    ...
    auto p = mio::abm::Person(rng, home.get_type(), home.get_id(), home.get_model_id(), age_group_15_to_34);
    p.set_assigned_location(home.get_type(), home.get_id(), home.get_model_id());
