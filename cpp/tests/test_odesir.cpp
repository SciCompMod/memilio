...
TEST(Testsir, get_reproduction_numbers)
{
    mio::osir::Model model;
    ...
    mio::TimeSeries<ScalarType> result((int)mio::osir::InfectionState::Count);
    ...
    result_0[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9700;
    result_1[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9699.9611995799496071;
    result_2[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9699.7865872644051706;
    result_3[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9699.0006179798110679;
    result_4[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9695.4591772453732119;
    result_5[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9679.4083551723888377;
    result_6[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9660.5835936179428245;
    ...
    model.parameters.get<mio::osir::ContactPatterns>().get_baseline()(0, 0) = 9;
    ...
    model.parameters.get<mio::osir::ContactPatterns>().get_baseline()(0, 0) = 8;
...
TEST(Testsir, get_reproduction_number)
{
    mio::osir::Model model;
    ...
    result_0[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9700;
    result_1[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9699.9709149074315;
    result_2[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9699.8404009584538;
    result_3[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9699.260556488618;
    result_4[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9696.800490904101;
    result_5[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9687.9435082620021;
    result_6[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9679.5436372291661;
    result_7[(Eigen::Index)mio::osir::InfectionState::Susceptible] = 9678.5949381732935;
