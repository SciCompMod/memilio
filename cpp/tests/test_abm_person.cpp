...
TEST(TestPerson, init)
{
    ...
    mio::abm::Location<double> location(mio::abm::LocationType::Work, 0, num_age_groups);
    auto t      = mio::abm::TimePoint(0);
    auto person = mio::abm::Person<double>(rng, location, age_group_60_to_79);
...
{
    auto rng             = mio::RandomNumberGenerator();
    auto location        = mio::abm::Location<double>(mio::abm::LocationType::Work, 0, num_age_groups);
    auto t               = mio::abm::TimePoint(0);
...
TEST(TestPerson, migrate)
{
    ...
    mio::abm::Location<double> loc1(mio::abm::LocationType::PublicTransport, 0, 6, 1);
    mio::abm::Location<double> loc2(mio::abm::LocationType::School, 0, num_age_groups);
    mio::abm::Location<double> loc3(mio::abm::LocationType::PublicTransport, 0, 6, 2);
...
{
    auto rng = mio::RandomNumberGenerator();
    mio::abm::Location<double> location(mio::abm::LocationType::Work, 2, num_age_groups);
...
TEST(TestPerson, get_tested)
{
    ...
    mio::abm::Location<double> loc(mio::abm::LocationType::Home, 0, num_age_groups);
    auto infected       = make_test_person(loc, age_group_15_to_34, mio::abm::InfectionState::InfectedSymptoms);
    auto rng_infected   = mio::abm::Person<double>::RandomNumberGenerator(rng, infected);
    auto susceptible    = mio::abm::Person(rng, loc, age_group_15_to_34);
    auto rng_suscetible = mio::abm::Person<double>::RandomNumberGenerator(rng, susceptible);
...
{
    mio::abm::Location<double> home(mio::abm::LocationType::Home, 0, 6, 1);
    mio::abm::Location<double> location(mio::abm::LocationType::PublicTransport, 0, 6, 2);
...
TEST(TestPerson, applyMaskIntervention)
{
    ...
    mio::abm::Location<double> home(mio::abm::LocationType::Home, 0, num_age_groups);
    mio::abm::Location<double> target(mio::abm::LocationType::Work, 0, num_age_groups);
...
{
    mio::abm::Location<double> location(mio::abm::LocationType::School, 0, num_age_groups);
...
{
    mio::abm::Location<double> location(mio::abm::LocationType::School, 0, 6);
...
{
    auto rng = mio::RandomNumberGenerator();
    mio::abm::Location<double> loc(mio::abm::LocationType::Home, 0);
