...
// {
//     // TODO: Gucken ob der Zusatz von Confirmed Compartments Einfluss auf dieses Beispiel hat
//     ScalarType t0   = 0;
//     ScalarType tmax = 30.00;
//     ScalarType dt   = 0.01;
...
//     model_ode.parameters.get<mio::osecir::TransmissionProbabilityOnContact>()[(mio::AgeGroup)0] = 0.7;
//     model_ode.parameters.get<mio::osecir::RelativeTransmissionNoSymptoms>()[(mio::AgeGroup)0]   = 0.7;
//     model_ode.parameters.get<mio::osecir::RiskOfInfectionFromSymptomatic>()[(mio::AgeGroup)0]   = 0.7;
...
//     // Initialize model.
//     mio::isecir::Model model_ide(std::move(init_transitions), N, Dead_before, 0);
...
//     // if (save_result) {
//     //     auto save_result_status = mio::save_result({secihurd_ode}, {0}, 1, "result_ode.h5");
//     //     auto save_result_status = mio::save_result({secihurd_ide}, {0}, 1, "result_ide.h5");
//     // }
// }