...
TEST(TestMasks, maskProtection)
{
    ...
    mio::abm::interact(p1_rng, susc_person1, infection_location, {susc_person1, susc_person2, infected1}, t, dt,
                       params);
    ...
    mio::abm::interact(p2_rng, susc_person2, infection_location, {susc_person1, susc_person2, infected1}, t, dt,
                       params);
