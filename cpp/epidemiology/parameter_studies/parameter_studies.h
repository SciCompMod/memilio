...
using seir_simulation_function_t = void (*)(const double t0, const double tmax, const double dt, struct seirParam<double> const& params, std::vector<std::vector<double> >& seir);
