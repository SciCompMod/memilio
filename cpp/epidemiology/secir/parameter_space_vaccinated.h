...
*/
#ifndef PARAMETER_SPACE_VACCINATED_H
#define PARAMETER_SPACE_VACCINATED_H
 ...
 * @param[inout] model SecirModelV including contact patterns for alle age groups
 */
...
/** Draws a sample from SecirModelV parameter distributions and stores sample values
...
#endif // PARAMETER_SPACE_VACCINATED_H
