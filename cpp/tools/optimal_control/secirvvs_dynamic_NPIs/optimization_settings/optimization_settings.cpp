...
std::vector<DynamicNPIControlParameter>& SecirvvsOptimization::control_parameters()
{
    return this->m_control_parameters;
}

const std::vector<DynamicNPIControlParameter>& SecirvvsOptimization::control_parameters() const
{
    return this->m_control_parameters;
}
