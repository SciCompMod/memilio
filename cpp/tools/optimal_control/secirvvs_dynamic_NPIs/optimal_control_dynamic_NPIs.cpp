...
int main(int argc, char* argv[])
{
    ...
    OptimizationModel optimization_model(data_directory, simulation_days, num_age_groups, npi_duration, npi_interval,
                                         npi_base);
    ...
    bool random_start            = true; // Set to true to randomize initial control values
    ...
    SecirvvsOptimization settings(optimization_model, num_control_intervals, pc_resolution, random_start,
                                  ...
                                  path_constraints, terminal_constraints);
