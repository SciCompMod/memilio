...
{
public:
    SecirOptimization(const OptimizationModel& optimization_model, size_t num_control_intervals, size_t pc_resolution,
                      bool random_start, IntegratorType integrator_type, size_t integrator_resolution, ADType ad_eval_f,
                      ADType ad_eval_jac, std::vector<DynamicNPIControlParameter> control_parameters,
    ...
    const std::vector<DynamicNPIControlParameter>& control_parameters() const;
...
private:
    ...
    std::vector<DynamicNPIControlParameter> m_control_parameters;
