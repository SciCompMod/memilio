...
/**
 * Make movement coefficient damping vector from dampings by group.
 * Maps the vector of dampings by group onto a movement coefficient damping vector
 * [g_0, g_0, ..., g_1, g_1, ..., g_2, ...].
 * @param shape shape (i.e. size) of the movement coefficient vector.
 * @param groups damping value weighted by group.
 * @return vector expression of movement coefficient damping.
 */
template <class V>
auto make_movement_damping_vector(ColumnVectorShape shape, V&& groups)
{
