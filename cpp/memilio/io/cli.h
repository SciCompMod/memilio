...
mio::IOResult<void> set_param_impl(const typelist<>, Set&, const std::string& identifier,
                                   const std::string&)
{
...
mio::IOResult<Set<Parameters...>> command_line_interface(const std::string& executable_name,
