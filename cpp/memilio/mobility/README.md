...
See the [mobility header](metapopulation_mobility_instant.h) and the `MobilityEdgeCompartments` and `SimulationNode` classes for technical details of the two phases.
