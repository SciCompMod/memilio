...
public:
    ...
    */
    using ParametersGraph = mio::Graph<typename Simulation::Model, mio::MovementParameters>;
    /**
    * The Graph type that stores simulations and their results of each run.
    * This is the output of ParameterStudies for each run.
    */
    using SimulationGraph = mio::Graph<mio::SimulationNode<Simulation>, mio::MovementEdge>;
