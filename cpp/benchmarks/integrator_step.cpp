...
BENCHMARK_TEMPLATE(integrator_step, mio::VRKIntegratorCore)->Name("simulate SecirModel vadapt_rk");
BENCHMARK_TEMPLATE(integrator_step, mio::RKFastIntegratorCore)->Name("simulate SecirModel adapt_rk_fast");
BENCHMARK_TEMPLATE(integrator_step, mio::VRKFastIntegratorCore)->Name("simulate SecirModel vadapt_rk_fast");
BENCHMARK_TEMPLATE(integrator_step, mio::VRKOptIntegratorCore)->Name("simulate SecirModel vadapt_rk_opt");
