                         ...
                         Eigen::Ref<Vector<FP>> dydt) const override
    {
        ...
        for (auto i = AgeGroup(0); i < n_agegroups; i++) {
            ...
            for (auto j = AgeGroup(0); j < n_agegroups; j++) {
                ...
                ScalarType coeffStoR1 = recovery_matrix_v1(static_cast<Eigen::Index>((size_t)i),
                                                                       static_cast<Eigen::Index>((size_t)j)) * 
                                        (1.0 / params.template get<TimeInfectedV1<FP>>());
                ScalarType coeffStoR2 = recovery_matrix_v2(static_cast<Eigen::Index>((size_t)i),
                                                                       static_cast<Eigen::Index>((size_t)j)) * 
                                        (1.0 / params.template get<TimeInfectedV2<FP>>());
                ScalarType coeffStoR3 = recovery_matrix_v3(static_cast<Eigen::Index>((size_t)i),
                                                                       static_cast<Eigen::Index>((size_t)j)) * 
