...
#ifndef LCT_SIR_PARAMS_H
#define LCT_SIR_PARAMS_H
...
/**********************************************
* Define Parameters of the LCT-SIR model *
**********************************************/
...
template <typename FP>
using ParametersBase = ParameterSet<TimeInfected<FP>, TransmissionProbabilityOnContact<FP>, ContactPatterns<FP>,
                                    RiskOfInfectionFromSymptomatic<FP>>;
...
public:
    ...
    bool check_constraints() const
    {
        ...
        for (size_t i = 0; i < m_num_groups; ++i) {
            if (this->template get<TimeInfected<FP>>()[i] < 1.0) {
