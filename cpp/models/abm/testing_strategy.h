...
public:
    ...
    bool operator==(const TestingScheme& other) const
    {
        return this->m_testing_criteria == other.m_testing_criteria &&
               ...
               FP(this->m_test_type.get_default().sensitivity) == FP(other.m_test_type.get_default().sensitivity) &&
               FP(this->m_test_type.get_default().specificity) == FP(other.m_test_type.get_default().specificity) &&
