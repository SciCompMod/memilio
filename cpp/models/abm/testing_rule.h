...
{
public:
    TestingRule(const std::vector<AgeGroup> ages = {}, const std::vector<LocationType> location_type = {}, const std::vector<InfectionState> infection_states = {});
    ...
    void set_age_groups(const std::vector<AgeGroup> ages);
    const std::vector<AgeGroup>& get_age_groups() const;
    void add_age_group(const AgeGroup ageGroup);
    void remove_age_group(const AgeGroup ageGroup);
    
    void set_location_types(const std::vector<LocationType> locationTypes);
    const std::vector<LocationType>& get_location_types() const;
    void add_location_type(const LocationType locationType);
    void remove_location_type(const LocationType locationType);
    
    void set_infection_states(const std::vector<InfectionState> infection_states);
    const std::vector<InfectionState>& get_infection_states() const;
