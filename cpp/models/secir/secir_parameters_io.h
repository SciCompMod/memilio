                                       ...
                                       int num_days)
{
    ...
    for (size_t j = 0; j < static_cast<size_t>(num_days); j++) {
        ...
        BOOST_OUTCOME_TRY(details::read_rki_data(
            path_join(data_dir, "cases_all_county_age_ma.json"), id_name, region, date, num_exp, num_car, num_inf, num_hosp,
                                            ...
                                            const std::string& dir)
{
    ...
    BOOST_OUTCOME_TRY(
        details::set_rki_data(model, path_join(dir, "cases_all_age_ma.json"), id_name, {0}, date, scaling_factor_inf));
    BOOST_OUTCOME_TRY(
                                ...
                                const std::string& dir)
{
    ...
    BOOST_OUTCOME_TRY(details::set_rki_data(model, path_join(dir, "cases_all_state_age_ma.json"), id_name, state, date,
                                            scaling_factor_inf));
    BOOST_OUTCOME_TRY(
                                           ...
                                           const std::string& dir)
{
    ...
    BOOST_OUTCOME_TRY(details::set_rki_data(model, path_join(dir, "cases_all_county_age_ma.json"), id_name, county, date,
                                            scaling_factor_inf));
    BOOST_OUTCOME_TRY(
