...
namespace iseir
{
    ...
    */
    ...
    /**
    * @brief The infection time used in the IDE SEIR model.
    * 
    * Infection time is the average time from onset of infectivity to recovery used in the model.
    * Infection time is measured in days.
    */
    ...
    * given that the contact takes place between a susceptible and a infected person.
    */
    ...
    /**
    * @brief The contact frequency is modelled using an UncertainContactMatrix.
    * 
    ...
    */
    ...
    using IdeSeirParameters = ParameterSet<TransmissionRisk, LatencyTime, InfectiousTime, ContactFrequency>;
