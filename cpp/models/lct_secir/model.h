...
private:
                              ...
                              Eigen::Ref<Eigen::VectorX<FP>> dydt) const
    {
        ...
        dydt[Ri] = dydt[ISyi_first_index] * params.template get<RecoveredPerInfectedNoSymptoms<FP>>()[Group];
        ...
        dydt[Ri] += dydt[ISevi_first_index] * (1 - params.template get<SeverePerInfectedSymptoms<FP>>()[Group]);
                  ...
                  Eigen::Ref<Eigen::VectorX<FP>> dydt) const
    {
        ...
        FP infectedNoSymptoms_2 = 0;
        FP infectedSymptoms_2   = 0;
        auto params             = this->parameters;
        ...
        dydt[Si_1] += -y[Si_1] * divN_2 * season_val *
                      ...
                      (params.template get<RelativeTransmissionNoSymptoms<FP>>()[Group2] * infectedNoSymptoms_2 +
                       params.template get<RiskOfInfectionFromSymptomatic<FP>>()[Group2] * infectedSymptoms_2);
