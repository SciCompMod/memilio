...
*/
#ifndef SEIRS_PARAMETERS_H
#define SEIRS_PARAMETERS_H
...
/***************************************
 * Define Parameters of the SEIRS model *
 ***************************************/
...
/**
 * @brief share of traced contagions that are directly isolated.
 */
template <typename FP = double>
struct ShareContagionsIsolated {
    using Type = CustomIndexArray<UncertainValue<FP>, AgeGroup>;
    static Type get_default(AgeGroup size)
    {
        return Type(size, 5.2);
    ...
    static std::string name()
    {
        return "ShareContagionsIsolated";
    }
};

/**
 * @brief the time which the immunity lasts in day unit
 */
template <typename FP = double>
struct TimeImmunity {
    using Type = CustomIndexArray<UncertainValue<FP>, AgeGroup>;
...
/**
 * @brief Detection rate of exposed individuals in the population when full tnt capacity is available.
 */
template <typename FP = double>
struct DetectionRateExposedMinRisk {
    using Type = UncertainValue<FP>;
    static Type get_default(AgeGroup)
    {
        return Type(0.0);
    ...
    static std::string name()
    {
        return "DetectionRateExposedMinRisk";
    }
};

/**
 * @brief Detection rate of exposed individuals in the population when tnt capacity is reached.
 */
template <typename FP = double>
struct DetectionRateExposedMaxRisk {
    using Type = UncertainValue<FP>;
    static Type get_default(AgeGroup)
    {
        return Type(0.0);
    ...
    static std::string name()
    {
        return "DetectionRateExposedMaxRisk";
    }
};

/**
 * @brief Detection rate of infected individuals in the population when full tnt capacity is available.
 */
template <typename FP = double>
struct DetectionRateInfectedMinRisk {
    using Type = UncertainValue<FP>;
    static Type get_default(AgeGroup)
    {
        return Type(0.0);
    ...
    static std::string name()
    {
        return "DetectionRateInfectedMinRisk";
    }
};

/**
 * @brief Detection rate of infected individuals in the population when tnt capacity is reached.
 */
template <typename FP = double>
struct DetectionRateInfectedMaxRisk {
    using Type = UncertainValue<FP>;
    static Type get_default(AgeGroup)
    {
        return Type(0.0);
    ...
    static std::string name()
    {
        return "DetectionRateInfectedMaxRisk";
    }
};
...
using ParametersBase =
    ParameterSet<TransmissionProbabilityOnContact<FP>, TimeExposed<FP>, TimeInfected<FP>, ContactPatterns<FP>,
                 ShareContagionsIsolated<FP>, TimeImmunity<FP>, TestAndTraceCapacity<FP>,
                 DetectionRateExposedMinRisk<FP>, DetectionRateExposedMaxRisk<FP>, DetectionRateInfectedMinRisk<FP>,
                 DetectionRateInfectedMaxRisk<FP>>;
