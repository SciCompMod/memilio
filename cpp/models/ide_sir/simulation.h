...
public:
     ...
     */
    void advance(ScalarType tmax, bool kahan = false, bool more_precise_s_deriv = false, bool S_deriv_forward = false,
                 ScalarType cutoff_window = 0., size_t fd_order_contacts = 4, ScalarType damping_time = 1000.,
                 ScalarType smoother_window = 1., size_t smoothstep_order = 0);
    ...
    void advance_reformulated2(ScalarType tmax, size_t fd_order);
