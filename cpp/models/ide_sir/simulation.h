...
public:
     ...
     */
    void advance(ScalarType tmax, bool kahan = false, bool more_precise_s_deriv = false, ScalarType cutoff_window = 0.,
                 size_t fd_order_contacts = 4, ScalarType damping_time = 1000., ScalarType smoother_window = 1.,
