...
size_t ModelMessinaExtendedDetailedInit::compute_S(ScalarType s_init, ScalarType dt, size_t t0_index,
                                                   size_t fd_order_contacts, ScalarType damping_time, ScalarType tol,
                                                   size_t max_iterations)
{
    ...
    while (iter_counter < max_iterations) {
        ...
        ScalarType s_new = fixed_point_function(s_init, dt, t0_index, fd_order_contacts, damping_time);
