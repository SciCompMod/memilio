...
public:
    ModelPolynomial(TimeSeries<ScalarType>&& populations_init, size_t gregory_order);
    ...
    void approx_single_integral(ScalarType dt, size_t t0_index);
    void approx_double_integral(ScalarType dt, size_t t0_index);
