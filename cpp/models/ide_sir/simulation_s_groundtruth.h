...
#ifndef IDE_SIR_SIMULATION_S_GT_H
#define IDE_SIR_SIMULATION_S_GT_H
...
class SimulationSusceptibleGroundtruth
{
...
public:
     ...
     */
    SimulationSusceptibleGroundtruth(ModelMessinaExtendedDetailedInit const& model, ScalarType dt)
     ...
     */
    void advance(ScalarType tmax, size_t t0_index);
