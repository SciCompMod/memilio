...
std::vector<AR> generic_adoption_rates()
{
    ...
    adoption_rates.push_back({InfectionState::S, InfectionState::E, home, 1.0, {{InfectionState::I, 0.24}}});
    ...
    adoption_rates.push_back({InfectionState::S, InfectionState::E, home, 0.0, {}});
