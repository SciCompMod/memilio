...
void write_log_to_file(const T& history)
{
    ...
    //3. enhance so it can be multiple loggers
    //4. Maybe put the write to file function into another function
    //5. write another writer, which only saves the delta of the data
}
