    ...
    for (size_t node_idx = 0; node_idx < nodes.size(); ++node_idx) {
        ...
        for (int t_idx = 0; t_idx < num_days; ++t_idx) {
            ...
            for (auto j = mio::AgeGroup(0); j < params.get_num_groups(); j++) {
                mobility_model.parameters.template get<mio::osecirvvs::DailyPartialVaccinations<double>>()[{j, t}] = 0;
                mobility_model.parameters.template get<mio::osecirvvs::DailyFullVaccinations<double>>()[{j, t}]    = 0;
