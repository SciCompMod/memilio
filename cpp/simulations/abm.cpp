...
void create_assign_locations(mio::abm::Model& model)
{
    ...
    model.get_testing_strategy().add_testing_scheme_location_type(mio::abm::LocationType::SocialEvent, testing_scheme);
    ...
    model.get_testing_strategy().add_testing_scheme_location_type(mio::abm::LocationType::School,
