...
void create_assign_locations(mio::abm::World& world)
{
    ...
    auto testing_criteria = std::vector<mio::abm::TestingCriteria<mio::abm::LocationType>>{
        mio::abm::TestingCriteria<mio::abm::LocationType>({}, test_at_social_event, {})};
    ...
    auto testing_criteria_school = std::vector<mio::abm::TestingCriteria<mio::abm::LocationType>>{
        mio::abm::TestingCriteria<mio::abm::LocationType>({}, test_at_school, {})};
