...
cmake --build . --target ode_seir_mobility_timing

srun --cpu-bind=cores --cpus-per-task=1 --cpu-freq=2200000-2200000 likwid-perfctr -C 0 -g MEM_DP -m ./bin/ode_seir_mobility_timing $warm_up_runs $runs $regions
