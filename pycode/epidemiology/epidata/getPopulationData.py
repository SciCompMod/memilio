...
def load_age_population_data(read_data, out_folder):
    ...
    if(read_data):
        ...
        #read tables
        counties = gd.loadExcel(os.path.join(path_counties,'kreise_deu.xlsx'),sheet_name=1, header=3)
        reg_key = gd.loadExcel(path_reg_key, sheet_name='Tabelle_1A', header=12)
