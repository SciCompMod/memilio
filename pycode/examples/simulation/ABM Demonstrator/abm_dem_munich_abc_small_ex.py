...
def run_abm_simulation(sim_num, kappa, init_e, damp_time, damp_lvl):
    ...
    output_path = os.getcwd() + '/output_small_ex/'
    ...
    # initialize model
    abm.initialize_model(sim.model, input_path + 'persons_small_ex.csv', os.path.join(
        input_path, 'hospitals_small_ex.csv'), os.path.join(
    ...
    #    output_path, str(sim_num) + '_mapping.txt'), os.path.join(input_path, 'ww_areas_small_ex.csv'), os.path.join(
    #    output_path, str(sim_num) + '_mapping_tan.txt'), os.path.join(
    #    output_path, str(sim_num) + '_mapping_tan_locs.txt'), "csv")
    #end_map = time.time()
    # print(
    ...
    assign_infection_states(sim.model, t0, init_e, 0.005,
                            0.0029, 0.0001, 0.0, 0.0, parameters, start_locs)
