...
class TestGetContactData(unittest.TestCase):
    ...
    def setUp(self):
        """ Set up temporary files and a dummy population for testing. """
        self._temp_files = []
        # dummy population of 100 for each of the 16 age groups
        self.dummy_pop = [100.0] * 16
    ...
    def test_load_contact_matrix_rki_groups(self):
        ...
        matrix = load_contact_matrix(
            "Germany", contact_path=contact_path, population=self.dummy_pop)
