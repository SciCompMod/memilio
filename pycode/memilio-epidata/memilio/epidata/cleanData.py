...
def clean_data(
        ...
        testing, hospitalization, hdf5, out_path):
...
def cli():
    ...
    return_args = [args.all_data, args.cases, args.john_hopkins, args.population,
                   ...
                   args.hospitalization, args.hdf5, args.out_path]
...
def main():
    ...
    [all_data, cases, john_hopkins, population, divi,
        vaccination, commuter, testing, hospitalization, hdf5, out_path] = cli()

    clean_data(all_data, cases, john_hopkins, population, divi,
               vaccination, commuter, testing, hospitalization, hdf5, out_path)
