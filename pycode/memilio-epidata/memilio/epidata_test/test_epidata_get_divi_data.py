...
{"Date":1588065300000,"ICU":0,"ICU_ventilated":0}""")
    ...
    @patch('memilio.epidata.getDIVIData.sys.exit')
    @patch('memilio.epidata.getDIVIData.pandas.read_csv')
    ...
    @patch('memilio.epidata.getDIVIData.call_call_url')
    ...
    @patch('memilio.epidata.getDIVIData.download_data_for_one_day')
