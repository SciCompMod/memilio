...
class TestGetVaccineData(fake_filesystem_unittest.TestCase):
    ...
    @patch('memilio.epidata.getVaccineData.download_vaccine_data', return_value=(test_vaccine_df, 'test_vaccine'))
    @patch('memilio.epidata.getVaccineData.getPopulationData.get_age_population_data', return_value=test_pop_df)
