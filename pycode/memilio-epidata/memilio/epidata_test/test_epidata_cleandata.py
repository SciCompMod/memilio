    ...
    def set_dirs_and_files(self, what):
        ...
        dir_dic_all = {
            ...
            ["cases_a", "a_jh", "CaseDataFull", "PopulData",
             ...
             "all_county_vacc", "all_state_vacc", "movement_bfa_2020_dim401",
        ...
        dir_dic_commuter = {
            'Germany': ["movement_bfa_2020_dim401"]}
        ...
        for dir in dir_list:
            ...
            if dir == "Germany":
                ...
                fakefiles = [
                    ...
                    "movement_bfa_2020_dim401.h5", "states_testpos.h5",
                    ...
                    "movement_bfa_2020_dim401.json", "states_testpos.json",
