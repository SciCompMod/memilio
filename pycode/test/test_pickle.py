...
class Test_Pickle(unittest.TestCase):
    ...
    def test_distribution(self):
        ...
        test = secir.ParameterDistributionNormal(0,1,0.4,0.1)
    ...
    def test_damping_sampling(self):
        test = secir.UncertainValue(2.2)
        test.set_distribution(secir.ParameterDistributionNormal(0, 1, 0.4, 0.1))
        test = secir.DampingSampling(test, 1, 2, 3, [0, 1], np.arange((2)))
        ...
        self.assertEqual(pickle_test.value.get_distribution().standard_dev, 0.1)
