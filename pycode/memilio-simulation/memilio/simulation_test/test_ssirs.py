...
class Test_ssirs_integration(unittest.TestCase):
    """Integration tests for the SDE SIRS Python bindings."""
    ...
    def test_check_constraints_parameters(self):
        ...
        # invalid: TimeImmune <= 0.1
        model.parameters.TimeInfected.value = 6.0
        model.parameters.TimeImmune.value = 0.0
        self.assertEqual(model.parameters.check_constraints(), 1)
