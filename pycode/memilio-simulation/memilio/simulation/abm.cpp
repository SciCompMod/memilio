...
PYBIND11_MODULE(_simulation_abm, m)
{
    ...
    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::TestParameters>(m, "TestParameters")
    ...
    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::TimeSpan>(m, "TimeSpan")
    ...
    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::TimePoint>(m, "TimePoint")
        .def(py::init<int>(), py::arg("seconds") = 0)
    ...
    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::LocationId>(m, "LocationId")
    ...
    pymio::bind_class<pymio::PickleFlag::NoPickling, mio::abm::Person>(m, "Person")
    ...
    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::TestingCriteria>(m, "TestingCriteria")
    ...
    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::GenericTest>(m, "GenericTest").def(py::init<>());
    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::AntigenTest, mio::abm::GenericTest>(m, "AntigenTest").def(py::init<>());
    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::PCRTest, mio::abm::GenericTest>(m, "PCRTest").def(py::init<>());

    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::TestingScheme>(m, "TestingScheme")
    ...
    pymio::bind_class<pymio::PickleFlag::TryPickling, mio::abm::TestingStrategy>(m, "TestingStrategy")
        .def(py::init<const std::vector<mio::abm::TestingScheme>&>());

    pymio::bind_class<pymio::PickleFlag::NoPickling, mio::abm::Location>(m, "Location")
    ...
    pymio::bind_class<pymio::PickleFlag::NoPickling, mio::abm::Trip>(m, "Trip")
    ...
    pymio::bind_class<pymio::PickleFlag::NoPickling, mio::abm::TripList>(m, "TripList")
        .def(py::init<>())
    ...
    pymio::bind_class<pymio::PickleFlag::NoPickling, mio::abm::World>(m, "World")
    ...
    pymio::bind_class<pymio::PickleFlag::NoPickling, mio::abm::Simulation>(m, "Simulation")
