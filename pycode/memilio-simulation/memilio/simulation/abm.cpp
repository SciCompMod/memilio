...
PYBIND11_MODULE(_simulation_abm, m)
{
    ...
    pymio::bind_class_optional_serialize<mio::abm::TestParameters>(m, "TestParameters")
    ...
    pymio::bind_class_optional_serialize<mio::abm::TimeSpan>(m, "TimeSpan")
    ...
    pymio::bind_class_optional_serialize<mio::abm::TimePoint>(m, "TimePoint")
        .def(py::init<int>(), py::arg("seconds") = 0)
    ...
    pymio::bind_class_optional_serialize<mio::abm::LocationId>(m, "LocationId")
    ...
    pybind11::class_<mio::abm::Person>(m, "Person")
    ...
    pymio::bind_class_optional_serialize<mio::abm::TestingCriteria>(m, "TestingCriteria")
    ...
    pymio::bind_class_optional_serialize<mio::abm::GenericTest>(m, "GenericTest").def(py::init<>());
    pymio::bind_class_optional_serialize<mio::abm::AntigenTest, mio::abm::GenericTest>(m, "AntigenTest").def(py::init<>());
    pymio::bind_class_optional_serialize<mio::abm::PCRTest, mio::abm::GenericTest>(m, "PCRTest").def(py::init<>());

    pymio::bind_class_optional_serialize<mio::abm::TestingScheme>(m, "TestingScheme")
    ...
    pymio::bind_class_optional_serialize<mio::abm::TestingStrategy>(m, "TestingStrategy")
        .def(py::init<const std::vector<mio::abm::TestingScheme>&>());

    pybind11::class_<mio::abm::Location>(m, "Location")
    ...
    pybind11::class_<mio::abm::Trip>(m, "Trip")
    ...
    pybind11::class_<mio::abm::TripList>(m, "TripList")
        .def(py::init<>())
    ...
    pybind11::class_<mio::abm::World>(m, "World")
    ...
    pybind11::class_<mio::abm::Simulation>(m, "Simulation")
