...
PYBIND11_MODULE(_simulation, m)
{
    ...
    auto damping_class = pymio::bind_class<pymio::EnablePickling::Required, mio::SquareDamping>(m, "Damping");
    pymio::bind_damping_members(damping_class);

    auto dampings_class = pymio::bind_class<pymio::EnablePickling::Required, mio::SquareDampings>(m, "Dampings");
    ...
    auto contact_matrix_class = pymio::bind_class<pymio::EnablePickling::Required, mio::ContactMatrix>(m, "ContactMatrix");
    ...
    auto contact_matrix_group_class = pymio::bind_class<pymio::EnablePickling::Required, mio::ContactMatrixGroup>(m, "ContactMatrixGroup");
    ...
    auto migration_damping_class = pymio::bind_class<pymio::EnablePickling::Required, mio::VectorDamping>(m, "MigrationDamping");
    pymio::bind_damping_members(migration_damping_class);

    auto migration_dampings_class = pymio::bind_class<pymio::EnablePickling::Required, mio::VectorDampings>(m, "MigrationDampings");
    pymio::bind_dampings_members(migration_dampings_class);

    auto migration_coeffs_class = pymio::bind_class<pymio::EnablePickling::Required, mio::MigrationCoefficients>(m, "MigrationCoefficients");
    pymio::bind_damping_expression_members(migration_coeffs_class);

    auto migration_coeff_group_class = pymio::bind_class<pymio::EnablePickling::Required, mio::MigrationCoefficientGroup>(m, "MigrationCoefficientGroup");
