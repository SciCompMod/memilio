...
void bind_Integrator_Core(pybind11::module_& m)
{
    ...
    pymio::bind_class<RungeKutta4Integrator, pymio::EnablePickling::Never, mio::IntegratorCore<double>,
                      std::shared_ptr<RungeKutta4Integrator>>(m, "RungeKutta4IntegratorCore")
        .def(pybind11::init<>());

    pymio::bind_class<mio::RKIntegratorCore<double>, pymio::EnablePickling::Never, mio::IntegratorCore<double>,
