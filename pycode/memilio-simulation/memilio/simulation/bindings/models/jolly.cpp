...
PYBIND11_MODULE(_simulation_jolly, m)
{
    m.def("simulate", &simulate, "Simulates the jolly model", py::arg("farm_file"), py::arg("tmax") = 40,
          ...
          py::arg("infection_baseline") = 0.0001, py::arg("culling_factor") = 0.99, py::arg("cutoff1") = 1000,
          py::arg("cutoff2") = 5000, py::arg("cutoff3") = 10000, py::arg("value2") = 0.5, py::arg("value3") = 0.2,
          py::arg("A0_SEI") = 0.2, py::arg("A0_EI") = 0.2, py::arg("A0_ID") = 0.2, py::arg("A0_DeathRate") = 0.000128,
          py::arg("A1_SEI") = 0.2, py::arg("A1_EI") = 0.2, py::arg("A1_ID") = 0.2, py::arg("A1_DeathRate") = 0.000128,
          py::arg("A2_SEI") = 0.2, py::arg("A2_EI") = 0.2, py::arg("A2_ID") = 0.2, py::arg("A2_DeathRate") = 0.000588,
          py::arg("A3_SEI") = 0.2, py::arg("A3_EI") = 0.2, py::arg("A3_ID") = 0.2, py::arg("A3_DeathRate") = 0.000588,
          py::arg("A4_SEI") = 0.2, py::arg("A4_EI") = 0.2, py::arg("A4_ID") = 0.2, py::arg("A4_DeathRate") = 0.000588,
    ...
    m.def("simulate_with_init", &simulate_with_init, "Simulates the jolly model with initialization from farm file",
          ...
          py::arg("infection_baseline"), py::arg("culling_factor"), py::arg("cutoff1"), py::arg("cutoff2"),
          py::arg("cutoff3"), py::arg("value2"), py::arg("value3"), py::arg("A0_SEI"), py::arg("A0_EI"),
          py::arg("A0_ID"), py::arg("A0_DeathRate"), py::arg("A1_SEI"), py::arg("A1_EI"), py::arg("A1_ID"),
          py::arg("A1_DeathRate"), py::arg("A2_SEI"), py::arg("A2_EI"), py::arg("A2_ID"), py::arg("A2_DeathRate"),
          py::arg("A3_SEI"), py::arg("A3_EI"), py::arg("A3_ID"), py::arg("A3_DeathRate"), py::arg("A4_SEI"),
          py::arg("A4_EI"), py::arg("A4_ID"), py::arg("A4_DeathRate"), py::arg("foi_inner_factor0") = 1.0,
          py::arg("foi_outer_factor0"), py::arg("foi_inner_factor1"), py::arg("foi_outer_factor1"),
          py::arg("foi_inner_factor2"), py::arg("foi_outer_factor2"), py::arg("foi_inner_factor3"),
    ...
    m.def("simulate_continued", &simulate_continued, "Simulates the jolly model continued from other simulation",
          ...
          py::arg("sensitivity"), py::arg("infection_baseline"), py::arg("culling_factor"), py::arg("cutoff1"),
          py::arg("cutoff2"), py::arg("cutoff3"), py::arg("value2"), py::arg("value3"), py::arg("A0_SEI"),
          py::arg("A0_EI"), py::arg("A0_ID"), py::arg("A0_DeathRate"), py::arg("A1_SEI"), py::arg("A1_EI"),
          py::arg("A1_ID"), py::arg("A1_DeathRate"), py::arg("A2_SEI"), py::arg("A2_EI"), py::arg("A2_ID"),
          py::arg("A2_DeathRate"), py::arg("A3_SEI"), py::arg("A3_EI"), py::arg("A3_ID"), py::arg("A3_DeathRate"),
          py::arg("A4_SEI"), py::arg("A4_EI"), py::arg("A4_ID"), py::arg("A4_DeathRate"),
