...
{
    bind_class_optional_serialize<mio::MigrationParameters>(m, name.c_str())
...
{
    bind_class_optional_serialize<mio::Edge<mio::MigrationParameters>>(m, name.c_str())
...
{
    bind_class_optional_serialize<mio::MigrationEdge>(m, name.c_str())
        .def(py::init<const Eigen::VectorXd&>(), py::arg("coeffs"))
...
{
    bind_class_optional_serialize<mio::Edge<mio::MigrationEdge>>(m, name.c_str())
        .def_property_readonly("start_node_idx",
