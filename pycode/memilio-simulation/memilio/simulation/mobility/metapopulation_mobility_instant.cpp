...
{
    bind_class<EnablePickling::IfAvailable, mio::MigrationParameters>(m, name.c_str())
...
{
    bind_class<EnablePickling::IfAvailable, mio::Edge<mio::MigrationParameters>>(m, name.c_str())
...
{
    bind_class<EnablePickling::IfAvailable, mio::MigrationEdge>(m, name.c_str())
        .def(py::init<const Eigen::VectorXd&>(), py::arg("coeffs"))
...
{
    bind_class<EnablePickling::IfAvailable, mio::Edge<mio::MigrationEdge>>(m, name.c_str())
        .def_property_readonly("start_node_idx",
