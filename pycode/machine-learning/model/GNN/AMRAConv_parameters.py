    ...
    if configurations == 'order2':
        class Net(Model):
            def __init__(self):
                ...
                self.conv2 = layer(number_of_n, order = 2, activation='relu')
                self.conv3 = layer(number_of_n, order = 2, activation='relu')
        ...
        class Net(Model):
            def __init__(self):
                ...
                self.conv2 = layer(number_of_n, order = 3, activation='relu')
                self.conv3 = layer(number_of_n, order = 3, activation='relu')
                self.dense = Dense(data.n_labels, activation="linear")
        ...
        class Net(Model):
            def __init__(self):
                ...
                self.conv2 = layer(number_of_n, iterations  = 2, activation='relu')
                self.conv3 = layer(number_of_n, iterations  = 2, activation='relu')
                self.dense = Dense(data.n_labels, activation="linear")
        ...
        class Net(Model):
            def __init__(self):
                ...
                self.conv2 = layer(number_of_n, iterations  = 3, activation='relu')
                self.conv3 = layer(number_of_n, iterations  = 3, activation='relu')
                self.dense = Dense(data.n_labels, activation="linear")
        ...
        class Net(Model):
            def __init__(self):
                ...
                self.conv2 = layer(number_of_n, share_weights  = True, activation='relu')
                self.conv3 = layer(number_of_n, share_weights  = True, activation='relu')
                self.dense = Dense(data.n_labels, activation="linear")
        ...
        class Net(Model):
            def __init__(self):
                ...
                self.conv2 = layer(number_of_n, order = 2, iterations = 2, share_weights  = True, activation='relu')
                self.conv3 = layer(number_of_n, order = 2, iterations = 2, share_weights  = True, activation='relu')
                self.dense = Dense(data.n_labels, activation="linear")
        ...
        class Net(Model):
            def __init__(self):
                ...
                self.conv2 = layer(number_of_n, order = 2, iterations = 2, share_weights  = True, dropout_rate = 0.2, activation='relu')
                self.conv3 = layer(number_of_n, order = 2, iterations = 2, share_weights  = True, dropout_rate = 0.2, activation='relu')
                self.dense = Dense(data.n_labels, activation="linear")
...
epochs = 1500
filename = '/dataframe_ARMAConv_4_512_30days_oldrange_withCV_hyperparameters.csv'

configurations = ['order2' , 'order3', 'iter2', 'iter3', 'shareW', 'order2_iter2_shareW', 'order2_iter2_shareW_dropout02' ]
for config  in configurations:
    train_and_evaluate_model(epochs, 0.001, parameters[0], config)
