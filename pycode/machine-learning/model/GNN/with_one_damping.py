...
path_data = os.path.join(
    ...
    'data/data_GNN_20pop_onedamp_30days_1k')
...
class MyDataset(spektral.data.dataset.Dataset):
    def read(self):
        ...
        return [spektral.data.Graph(x=x, y=y, e=self.e*(1-damp), a=self.a*(1-damp)) for x, y, damp in zip(node_features, node_labels, dampings)]
