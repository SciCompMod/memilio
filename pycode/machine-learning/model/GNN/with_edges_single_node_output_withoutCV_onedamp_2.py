...
# this file contains another attempt of implementing dampings 
# instead of creating an edge feature array with a the number of commuters of each day, we try to see, how the model 
# performs, when we only provide: number of commuters(normally), damping factor and damping day
