...
# for mlp and cnn (?)
  ...
  # for lstm :
    ...
    #                                contact_matrices_train.shape[0], 5, 108])
...
def get_simulation_data():
    ...
    path_data = os.path.join(os.path.dirname(os.path.realpath(
        os.path.dirname(os.path.realpath(path)))), 'data_simulation_new')
    # path_data = os.path.join(os.path.dirname(os.path.realpath(
...
def simulation(model):
    ...
    #     #third_days = int(labels_run.shape[0]/48 - t3)
    #     third_days = 20
    #     # results = np.append(
    #     #    results, (third_output.reshape(960)[:(third_days*6*8)]))

    #     results = np.append(results, third_output.reshape(960))
