...
filenames = ["data_secir_groups_30days_nodamp_1input.pickle", "data_secir_groups_30days_nodamp_2input.pickle", "data_secir_groups_30days_nodamp_3input.pickle",
             "data_secir_groups_30days_nodamp_4input.pickle", "data_secir_groups_30days_nodamp_5input.pickle"]
             
filename_df = "dataframe_groups30_new"
...
def train_and_evaluate_model(param, max_epochs, filename):
    layer =0
    neuron_number = 512
    modelname = 'LSTM'
...
for filename in filenames:
     train_and_evaluate_model(parameters, max_epochs, filename)
