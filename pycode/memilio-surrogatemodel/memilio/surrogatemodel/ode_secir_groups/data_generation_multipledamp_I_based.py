...
from memilio.surrogatemodel.utils_surrogatemodel import (
    remove_confirmed_compartments, get_population, getBaselineMatrix, generate_dampings_withshadowdamp)
...
def generate_data(
        num_runs, number_of_dampings, path_out, path_population, input_width, label_width, filename,
   ...
   """
    ...
    for i in range(0, num_runs):
        ...
        data_run, damped_matrices, damping_coefficients = run_secir_groups_simulation(
            days, damping_days[i], population)
...
if __name__ == "__main__":
    ...
    filename = 'data_secir_groups_30days_Germany_10k_I_based_3damp.pickle'

    input_width = 5
    label_width = 30
    num_runs = 10000
    number_of_dampings = 3  # number of dampings
    data = generate_data(num_runs, number_of_dampings, path_output, path_population, input_width,
