...
epochs = 1500
filename = '/GNN_30days_nodeswithvariance_1k_test_2ndrun.csv'  # name for df
filename_df = 'GNN_30days_nodeswithvariance_1k_test_2ndrun.csv'  # name for df
save_name = 'GNN_30days_nodeswithvariance_1k_test_2ndrun'  # name for model
