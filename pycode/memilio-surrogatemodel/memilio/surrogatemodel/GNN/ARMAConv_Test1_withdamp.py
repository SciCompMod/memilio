...
epochs = 1500
filename = '/GNN_30days_samenodes_1k_2damp_test.csv'  # name for df
filename_df = 'GNN_30days_samenodes_1k_2_damp_test.csv'  # name for df
save_name = 'GNN_30days_samenodes_1k_2damp_test'  # name for model
