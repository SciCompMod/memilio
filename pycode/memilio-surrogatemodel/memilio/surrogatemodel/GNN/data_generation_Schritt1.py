    ...
    for node_indx in range(graph.num_nodes):
        ...
        for i in range(num_groups):
            ...
            model.populations[age_group, Index_InfectionState(
                InfectionState.InfectedSymptoms)] = pop_age_group * p_infected

            model.populations[age_group, Index_InfectionState(
                InfectionState.Exposed)] = model.populations[age_group,
                                                             InfectionState.InfectedSymptoms].value * p_exposed

            model.populations[age_group, Index_InfectionState(
                InfectionState.InfectedNoSymptoms)] = model.populations[age_group,
                                                                        InfectionState.InfectedSymptoms].value * p_ins

            model.populations[age_group, Index_InfectionState(
                InfectionState.InfectedSevere)] = model.populations[age_group,
                                                                    InfectionState.InfectedSymptoms].value * p_hosp
            model.populations[age_group, Index_InfectionState(
                InfectionState.InfectedCritical)] = model.populations[age_group,
                                                                      InfectionState.InfectedSevere].value * p_icu

            model.populations[age_group, Index_InfectionState(
                InfectionState.Dead)] = model.populations[age_group,
                                                          InfectionState.InfectedCritical].value * p_dead
            ...
            model.populations[age_group, Index_InfectionState(
                InfectionState.Recovered)] = pop_age_group*p_recovered
...
def generate_data(
   ...
   """
    ...
    if save_data:
        ...
        with open(os.path.join(path, 'GNN_data_30days_samenodes_10k.pickle'), 'wb') as f:
