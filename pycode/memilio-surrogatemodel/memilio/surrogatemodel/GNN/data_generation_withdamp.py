...
from .GNN_utils import (getBaselineMatrix, make_graph,
                        remove_confirmed_compartments, getMinimumMatrix, get_population)
...
def generate_data(
   ...
   """
    ...
    if save_data:
        ...
        #  Reverse the transpose of inputs
        ...
        # Reverse the transpose of labels
