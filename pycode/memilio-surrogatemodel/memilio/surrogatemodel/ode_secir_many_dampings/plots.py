...
df_damps_100days_MLP = pd.read_csv('pycode/memilio-surrogatemodel/memilio/secir_groups_2345damp/dataframe_secirgroups_2345damp_adjusted_MLP_LSTM')
df_damps_100days_MLP = df_damps_100days_MLP[df_damps_100days_MLP['Model']=='Dense']

df_damps_100days_CNN = pd.read_csv('pycode/memilio-surrogatemodel/memilio/secir_groups_2345damp/dataframe_secirgroups_2345damp_adjusted_CNN_2conv')
df_damps_100days_LSTM = pd.read_csv('pycode/memilio-surrogatemodel/memilio/secir_groups_2345damp/dataframe_secirgroups_2345damp_adjusted_LSTM')
...
# cancat all dfs together
df_all = pd.concat([df_damps_100days_MLP, df_damps_100days_CNN, df_damps_100days_LSTM, df_nodamp_100days, df_one_damp])
