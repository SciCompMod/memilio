...
def run_secir_groups_simulation(days, number_of_dampings, populations):
   ...
   """
    ...
    for damp_day in damping_days:
        ...
        model.parameters.ContactPatterns.cont_freq_mat.add_damping(Damping(
            coeffs=(damping), t=damp_day, level=0, type=0))
...
def generate_data(
   ...
   """
    ...
    for _ in range(0, num_runs):
        ...
        data_run, damped_contact_matrix, damping_days = run_secir_groups_simulation(
            days, number_of_dampings,  population[random.randint(0, len(population) - 1)])
