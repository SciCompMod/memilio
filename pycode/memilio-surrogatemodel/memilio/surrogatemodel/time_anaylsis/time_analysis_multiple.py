...
# this file compares the time for creating and predicting exactly multiple data samples
...
for modelname, filename in zip(model_names, filenames):
        ...
        for i in range(iterations): 
                ...
                start = time.time()
                pred = secirsimple_model.predict(test_inputs[:runs])
                end = time.time()
                times.append(end - start)
...
for modelname, filename in zip(model_names, filenames):
        ...
        for i in range(iterations):
                ...
                start = time.time()
                pred = secirgroups_model.predict(test_inputs[:runs])
                end = time.time()
                times.append(end - start)
