from epidemiology.secir import Damping, SeirParams, print_seir_params, simulate, SecirResult
...
def plot_secir():
    ...
    params = SeirParams(tinc, tinfmild, tserint, thosp2home, thome2hosp, thosp2icu, ticu2home, tinfasy, ticu2death,
