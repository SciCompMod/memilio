...
def simulator_SIR(params: list[float], T: int, N: int, intervention_model: bool, observation_model: bool, param_names: list[str], fixed_params: dict[str, float] = dict(), sim_diff: int = 16) -> npt.NDArray[np.float64]:
