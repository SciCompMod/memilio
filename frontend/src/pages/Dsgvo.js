...
export default function DSGVO() {
  ...
  return (
    <div className="dsgvo">
      ...
      <p>
        Das DLR nimmt den Schutz personenbezogener Daten sehr ernst. Wir möchten, dass Sie wissen, wann wir welche Daten
        speichern und wie wir sie verwenden. Als eingetragener Verein des deutschen Bürgerlichen Rechts unterliegen wir
        den Bestimmungen der EU-
        <a href="https://dsgvo-gesetz.de/" target="blank">
        ...
        sowie des{' '}
        <a href="https://www.gesetze-im-internet.de/tmg/" target="blank">
      ...
      <b>III. Begriffsbestimmungen</b>
      <br />
      <br />
      <p>
        In Übereinstimmung mit der Datenschutzgrundverordnung und dem Bundesdatenschutzgesetz verwenden wir in dieser
        Datenschutzerklärung unter anderem die folgenden Begriffe:
      </p>
      <p>
        <i>1. Personenbezogene Daten</i>
      </p>
      <p>
      ...
      <p>
        <i>4. Einschränkung der Verarbeitung</i>
      </p>
      <p>
      ...
      <p>
        <i>7. Verantwortlicher oder für die Verarbeitung Verantwortlicher</i>
      </p>
      <p>
      ...
      <b>IV. Allgemeines zur Datenverarbeitung</b>
      <br />
      <br />
      <p>
        <i>1. Umfang der Verarbeitung personenbezogener Daten</i>
      </p>
      <p>
      ...
      <p>
        <i>2. Rechtsgrundlage für die Verarbeitung personenbezogener Daten</i>
      </p>
      <p>
      ...
      <p>
        ...
        der unser Forschungszentrum unterliegt, dient Art. 6 Abs. 1 lit. c DSGVO als Rechtsgrundlage. Für den Fall, dass
      ...
      <p>
        Ist die Verarbeitung zur Wahrung eines berechtigten Interesses unseres Forschungszentrums oder eines Dritten
      ...
      <p>
        <i>3. Datenlöschung und Speicherdauer</i>
      </p>
      <p>
      ...
      <b>V. Bereitstellung der Website und Erstellung von Logfiles</b>
      <br />
      <br />
      <p>
        <i>a) Beschreibung und Umfang der Datenverarbeitung</i>
      </p>
      <p>
      ...
      <p>
        <i>b) Rechtsgrundlage für die Datenverarbeitung</i>
      </p>
      <p>
        Rechtsgrundlage für die vorübergehende Speicherung der Daten und der Logfiles ist Art. 6 Abs. 1 lit. f DSGVO.
      </p>
      <p>
        <i>c) Zweck der Datenverarbeitung</i>
      </p>
      <p>
      ...
      <p>
        Die Internetseite des DLR erfasst mit jedem Aufruf der Internetseite durch eine betroffene Person oder ein
        ...
        Gefahrenabwehr im Falle von Angriffen auf unsere informationstechnologischen Systeme dienen. Bei der Nutzung
        dieser allgemeinen Daten und Informationen zieht das DLR keine Rückschlüsse auf die betroffene Person. Diese
        Informationen werden vielmehr benötigt, um (1) die Inhalte unserer Internetseite korrekt auszuliefern, (2) die
        Inhalte unserer Internetseite (3) die dauerhafte Funktionsfähigkeit unserer informationstechnologischen Systeme
        und der Technik unserer Internetseite zu gewährleisten sowie (4) um Strafverfolgungsbehörden im Falle eines
        Cyberangriffes die zur Strafverfolgung notwendigen Informationen bereitzustellen. Diese anonym erhobenen Daten
        und Informationen werden durch das DLR daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den
        Datenschutz und die Datensicherheit in unserem Forschungszentrum zu erhöhen, um letztlich ein optimales
      ...
      <p>
        ...
        Sitzung beendet ist. Im Falle der Speicherung der Daten in Logfiles ist dies nach spätestens sieben Tagen der
        Fall. Eine darüberhinausgehende Speicherung ist möglich. In diesem Fall werden die IP-Adressen der Nutzer
        gelöscht oder verfremdet, sodass eine Zuordnung des aufrufenden Clients nicht mehr möglich ist.
      </p>
      <p>
        <i>e) Widerspruchs- und Beseitigungsmöglichkeit</i>
      </p>
      <p>
      ...
      <b>VII. Rechte der betroffenen Person</b>
      <br />
      <br />
      <p>
        Werden Ihre personenbezogenen Daten verarbeitet, sind Sie Betroffener i.S.d. DSGVO und es stehen Ihnen folgende
        Rechte gegenüber dem Verantwortlichen zu:
      </p>
      <p>
        <i>a) Auskunftsrecht</i>
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          Ihnen steht außerdem das Recht zu, Auskunft darüber zu verlangen, ob die Sie betreffenden personenbezogenen
      ...
      <p>
        ...
        Verfügung. Für alle weiteren Kopien, die Sie beantragen, kann der Verantwortliche ein angemessenes Entgelt auf
        der Grundlage der Verwaltungskosten verlangen. Stellen Sie den Antrag elektronisch, so sind die Informationen in
        einem gängigen elektronischen Format zur Verfügung zu stellen, sofern sie nichts anderes angibt. Das Recht auf
        Erhalt einer Kopie gemäß Absatz 3 darf die Rechte und Freiheiten anderer Personen nicht beeinträchtigen.
      </p>
      <p>
        <i>b) Recht auf Berichtigung</i>
      </p>
      <p>
        Sie als die betroffene Person haben das Recht, von dem Verantwortlichen unverzüglich die Berichtigung Sie
        betreffender unrichtiger personenbezogener Daten zu verlangen. Unter Berücksichtigung der Zwecke der
        Verarbeitung haben Sie das Recht, die Vervollständigung unvollständiger personenbezogener Daten - auch mittels
        einer ergänzenden Erklärung - zu verlangen.
      </p>
      <p>
        <i>c) Recht auf Einschränkung der Verarbeitung</i>
      </p>
      <p>
      ...
      <p>
        <i>d) Recht auf Löschung</i>
      </p>
      <p>
        <i>Löschungspflicht</i>
        <br />
      ...
      <ul>
        <li>
          ...
          verarbeitet wurden, nicht mehr notwendig. Sie widerrufen Ihre Einwilligung, auf die sich die Verarbeitung gem.
          Art. 6 Abs. 1 lit. a oder Art. 9 Abs. 2 lit. a DSGVO stützte, und es fehlt an einer anderweitigen
      ...
      <p>
        <i>f) Recht auf Datenübertragbarkeit</i>
      </p>
      <p>
      ...
      einem Vertrag gem. Art. 6 Abs. 1 lit. b DSGVO beruht und • die Verarbeitung mithilfe automatisierter Verfahren
      erfolgt.
      <p>
        ...
        machbar ist. Freiheiten und Rechte anderer Personen dürfen hierdurch nicht beeinträchtigt werden. Das Recht auf
        Datenübertragbarkeit gilt nicht für eine Verarbeitung personenbezogener Daten, die für die Wahrnehmung einer
        Aufgabe erforderlich ist, die im öffentlichen Interesse liegt oder in Ausübung öffentlicher Gewalt erfolgt, die
        dem Verantwortlichen übertragen wurde.
      </p>
      <p>
        <i>g) Widerspruchsrecht</i>
      </p>
      <p>
      ...
      <p>
        ...
        denen technische Spezifikationen verwendet werden. Sie als die betroffene Person haben das Recht, aus Gründen,
        die sich aus ihrer besonderen Situation ergeben, gegen die sie betreffende Verarbeitung sie betreffender
        personenbezogener Daten, die zu wissenschaftlichen oder historischen Forschungszwecken oder zu statistischen
        Zwecken gemäß Artikel 89 Absatz 1 erfolgt, Widerspruch einzulegen, es sei denn, die Verarbeitung ist zur
      ...
      <p>
        <i>h) Recht auf Widerruf erteilter Einwilligungen gemäß Art. 7 Abs. 3 DSGVO</i>
      </p>
      <p>
        Sie haben das Recht, eine einmal erteilte Einwilligung in die Verarbeitung von Daten jederzeit mit Wirkung für
        die Zukunft zu widerrufen. Im Falle des Widerrufs werden wir die betroffenen Daten unverzüglich löschen, sofern
        eine weitere Verarbeitung nicht auf eine Rechtsgrundlage zur einwilligungslosen Verarbeitung gestützt werden
        kann. Durch den Widerruf der Einwilligung wird die Rechtmäßigkeit der aufgrund der Einwilligung bis zum Widerruf
        erfolgten Verarbeitung nicht berührt.
      </p>
      <p>
        <i>i) Automatisierte Entscheidung im Einzelfall einschließlich Profiling</i>
      </p>
      <p>
        Sie haben das Recht, nicht einer ausschließlich auf einer automatisierten Verarbeitung – einschließlich
        Profiling – beruhenden Entscheidung unterworfen zu werden, die Ihnen gegenüber rechtlicher Wirkung entfaltet
        oder Sie in ähnlicher Weise erheblich beeinträchtigt.
      </p>
      Dies gilt nicht, wenn die Entscheidung • für den Abschluss oder die Erfüllung eines Vertrags zwischen Ihnen und
      dem Verantwortlichen erforderlich ist, • aufgrund von Rechtsvorschriften der Union oder der Mitgliedstaaten, denen
      der Verantwortliche unterliegt, zulässig ist und diese Rechtsvorschriften angemessene Maßnahmen zur Wahrung Ihrer
      Rechte und Freiheiten sowie Ihrer berechtigten Interessen enthalten oder • mit Ihrer ausdrücklichen Einwilligung
      erfolgt.
      <p>
      ...
      <p>
        <i>j) Recht auf Beschwerde bei einer Aufsichtsbehörde</i>
      </p>
      <p>
