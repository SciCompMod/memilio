...
def plot_susceptibles(files, fileending, save_dir=""):
    ...
    for file in range(len(files)):
        ...
        axs[0].plot(dates,
                    groundtruth_at_timepoints_S, label=labels[0],  linestyle=linestyles[1], color=colors[1], linewidth=linewidth)
        groundtruth_at_timepoints_S_deriv = [
            np.sinh(timepoint) for timepoint in dates]
        axs[1].plot(dates,
                    groundtruth_at_timepoints_S_deriv, label=labels[0],  linestyle=linestyles[1], color=colors[1], linewidth=linewidth)
        axs[2].plot(dates,
                    groundtruth_at_timepoints_S, label=labels[0],  linestyle=linestyles[1], color=colors[1], linewidth=linewidth)
