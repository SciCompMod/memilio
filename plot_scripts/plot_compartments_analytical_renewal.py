...
def plot_susceptibles(files, fileending, rho, kappa, save_dir=""):
    """
    ...
    for file in range(len(files)):
        ...
        for i in range(num_plots):
            axs[i].plot(dates,
                        total[:, i], label=labels[1],  linestyle=linestyles[0], color=colors[0], linewidth=linewidth)
