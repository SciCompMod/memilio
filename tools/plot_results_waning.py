...
secir_dict = {0: 'SusceptibleNaive', 1: 'SusceptiblePartialImmunity', 2: 'ExposedNaive', 3: 'ExposedPartialImmunity',
              4: 'ExposedImprovedImmunity', 5: 'CarrierNaive', 6: 'CarrierPartialImmunity',
              7: 'CarrierImprovedImmunity ', 8: 'CarrierNaiveConfirmed', 9: 'CarrierPartialImmunityConfirmed',
              10: 'CarrierImprovedImmunityConfirmed', 11: 'InfectedNaive', 12: 'InfectedPartialImmunity',
              13: 'InfectedImprovedImmunity', 14: 'InfectedNaiveConfirmed', 15: 'InfectedPartialImmunityConfirmed',
              16: 'InfectedImprovedImmunityConfirmed', 17: 'HospitalizedNaive', 18: 'HospitalizedPartialImmunity',
              19: 'HospitalizedImprovedImmunity', 20: 'ICUNaive', 21: 'ICUPartialImmunity',
              22: 'ICUImprovedImmunity', 23: 'Recovered', 24: 'Dead', 25: 'TotalInfections', 26: 'TemporaryImmunity1', 27: 'TemporaryImmunity2'}
...
secir_dict = {0: 'Susceptible', 1: 'Partially Vaccinated', 2: 'Exposed', 3: 'ExposedV1', 4: 'ExposedV2', 5: 'Carrier',
              ...
              21: 'ICUV1', 22: 'ICUV2', 23: 'Immune', 24: 'Dead', 25: 'Infected Total', 26: 'TemporaryImmunity1', 27: 'TemporaryImmunity2'}

# Define aggregated infection states to plot and create 'concat_comps' dictionary for aggregation
secir_dict_aggregated = {0: 'Susceptible', 1: 'Partially Vaccinated', 2: 'Exposed', 3: 'Carrier', 4: 'Infected',
                         5: 'Hospitalized', 6: 'ICU', 7: 'Immune', 8: 'Dead', 9: 'Infected Total', 10: 'TemporaryImmunity'}
concat_comps = {0: [0], 1: [1], 7: [23], 8: [24], 9: [25], 10: [26]}
for i in range(2, 7):
    concat_comps[i] = []
...
path_sim = ''
path_rki = 'data/'
scenario_list = ['szenario_1_vacc_camp_2_vacc_eff_1']

# Provide a list of labels for corresponding plots
scenario_label = {
    '': 'New variant with Immune escape but same disease severity'
}
...
plotConfidence = False   # Plots 05 and 95 percentiles if true3
